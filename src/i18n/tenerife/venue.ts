...
export const venue = {
  ...
  copy: createTranslation({
    en: 'Campers stay at a 4-star property in Puerto de la Cruz, two minutes on foot from Martiánez beach. Rooms are shared between three campers, with all meals — breakfast, lunch and dinner — included on site. The northern coast keeps a mild climate even at the height of summer, so days outside stay comfortable.',
    es: 'Los campistas se alojan en un establecimiento de 4 estrellas en Puerto de la Cruz, a dos minutos a pie de la playa de Martiánez. Las habitaciones son compartidas entre tres campistas, con todas las comidas — desayuno, almuerzo y cena — incluidas en el lugar. La costa norte mantiene un clima suave incluso en pleno verano, así que los días al aire libre se disfrutan cómodos.'
  }),
